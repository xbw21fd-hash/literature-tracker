...
authors: "Jesco Talies, Eric Breitbarth and David Melching"
link: "https://iopscience.iop.org/article/10.1088/2632-2153/ae3660"
---
...
- **作者**: Jesco Talies, Eric Breitbarth and David Melching
- **发表日期**: 2026-01-21
- **原文链接**: [https://iopscience.iop.org/article/10.1088/2632-2153/ae3660](https://iopscience.iop.org/article/10.1088/2632-2153/ae3660)
...
## 摘要（中文）
确保深度学习模型的可信性和稳健性仍然是一项根本挑战，特别是在高风险的科学应用中。在这项研究中，我们提出了一个称为注意力引导训练的框架，它将可解​​释的人工智能技术与定量评估和特定领域的先验结合起来，以指导模型注意力。我们证明，在训练期间对模型解释的特定领域反馈可以增强模型的泛化能力。我们在数字图像相关数据中的语义裂纹尖端分割任务上验证了我们的方法，这是材料断裂力学表征中的关键应用。通过将模型注意力与物理上有意义的压力场（例如威廉姆斯的分析解决方案所描述的压力场）结合起来，注意力引导训练可确保模型专注于物理相关区域。这最终导致概括性的改进和更忠实的解释。
