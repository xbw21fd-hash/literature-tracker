---
id: 0a58c3c4e7ec
title: "Emergence of Structural Disparities in theWeb of Scientific Citations"
title_zh: "科学引文网络中结构性差异的出现"
date: 2026-01-21
...
## 摘要（中文）
arXiv:2601.12665v1 公告类型：新 摘要：科学注意力分布不均，造成认可上的不平等并扭曲了获得机会的机会。使用引用作为代理，我们量化了性别和机构声望的关注差异。我们发现，女性获得的引用普遍少于男性，而且注意力越来越集中在来自精英机构的作者身上——这种模式并不能仅用代表性不足来完全解释。为了解释这些动态，我们引入了一个引用网络增长模型，该模型结合了同质性（引用相似作者的倾向）、优先依恋（偏爱高被引作者）和群体规模（代表性不足）。该模型表明，差异不仅源于群体规模的不平衡，还源于累积优势放大了有偏见的引用偏好。重要的是，仅增加代表性往往不足以减少差距。有效的策略还应包括减少同质性、扩大代表性不足群体的知名度以及支持新移民的公平融入。我们的研究结果强调了减轻非对称网络（如引文）中的不平等所面临的挑战，在非对称网络中，认可流向一个方向。通过公开分配注意力的机制，我们致力于建立一个更负责任的科学网络，该网络更公平、更透明、更具包容性，并能更好地维持创新和知识生产。
